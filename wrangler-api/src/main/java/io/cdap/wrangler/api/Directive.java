 ...
 * @Override public UsageDefinition define() {
 * UsageDefinition.Builder builder = UsageDefinition.builder();
 * builder.define("col", TokenType.COLUMN_NAME)
 * return builder.build();
 * }
 * @Override public void initialize(Argument args) throws DirectiveParseException {
 * this.columnArgs = args.value("col");
 * }
 * @Override public List<Row> execute(List<Row> rows, ExecutorContext context)
